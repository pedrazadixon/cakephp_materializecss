...
<div class="row">
  <div class="col s6 offset-s1">
    ...
    <?php echo $this->Form->create('User'); ?>
      ...
      <i class="material-icons prefix" style="padding-top: 10px;">edit</i>
        <?php echo $this->Form->input('nombres', array('label' => 'Nombres' , 'div'=>false , 'class' => 'validate')); ?>
      </div>

      <div class="input-field col s12">
      <i class="material-icons prefix" style="padding-top: 10px;">edit</i>
        <?php echo $this->Form->input('apellidos', array('label' => 'Apellidos' , 'div'=>false , 'class' => 'validate')); ?>
      </div>
